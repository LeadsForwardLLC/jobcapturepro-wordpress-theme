<?php
/**
 * Template Name: Job Proof Demo Run
 * Personalized demo environment: /job-proof-demo/demo/
 *
 * @package JCP_Core
 */
...
$trial_href = function_exists( 'jcp_core_onboarding_app_url_raw' )
	? jcp_core_onboarding_app_url_raw(
		function_exists( 'jcp_core_onboarding_utm_defaults' )
			? jcp_core_onboarding_utm_defaults( 'job_proof_demo_run_trial' )
			: []
	)
	: 'https://app.jobcapturepro.com/onboarding';

$expert_href = home_url( '/personalized-demo/' );
$lp_href     = home_url( '/job-proof-demo/' );
$case_href   = function_exists( 'jcp_case_study_url' )
	? jcp_case_study_url( 'job_proof_demo_run_exit' )
	: home_url( '/case-study/' );
...
<body
	<?php body_class( 'jcp-job-proof-demo-run jcp-landing-chrome-hidden jcp-marketing jcp-page-marketing jcp-page-campaign jcp-home' ); ?>
...
<a class="skip-link screen-reader-text" href="#jpd-run-main"><?php esc_html_e( 'Skip to content', 'jcp-core' ); ?></a>

<header class="jcp-landing-brandbar is-compact" role="banner" data-jcp-landing-brandbar>
	<div class="jcp-landing-brandbar__inner">
		<a href="<?php echo esc_url( $lp_href ); ?>" class="jcp-landing-brandbar__link" aria-label="<?php esc_attr_e( 'JobCapturePro', 'jcp-core' ); ?>">
			<img
		...
		<a
			...
			data-jpd-trial
			data-jpd-source="run_brandbar"
		><?php esc_html_e( 'Start free trial', 'jcp-core' ); ?></a>
	</div>
</header>

<main id="jpd-run-main" class="jcp-marketing jcp-niche jcp-page-marketing jcp-page-campaign jcp-home jpd-run">
	<?php require get_template_directory() . '/templates/job-proof-demo/demo-run.php'; ?>
</main>
