...
function jcp_block_registry(): array {
	return [
		...
		'core_mechanic' => [
			...
			'description'  => __( 'Badge stats row (e.g. 1 photo · 5 places · More jobs)', 'jcp-core' ),
			'category'     => 'content',
		...
		'testimonials' => [
			...
			'description'  => __( 'Customer review grid with optional faces strip', 'jcp-core' ),
			'category'     => 'content',
