...
function jcp_sales_tool_call_script_chapters(): array {
	return [
		...
		[
			...
			'say'   => 'Here’s what operators and agencies say after they turn job photos into a system. [Read 1–2 snippets.] If local Maps coverage matters for leads, we can also walk Acculevel’s LocalFalcon movement — measured visibility that feeds more calls, not hype.',
...
function jcp_sales_tool_call_script_objections(): array {
	return [
		...
		[
			...
			'say'   => 'Helpful — social is one of four publish channels. The bigger gap is usually geotagged local-SEO website content, Google Maps updates that drive calls, directory presence, and the on-site review ask from the same job.',
			'proof' => 'Ask how often one job hits all four channels plus a review.',
		],
		[
			'title' => 'Will this guarantee rankings?',
			'say'   => 'No honest platform can. What we do is give you a steady supply of what today’s search — including AI answers — rewards: real jobs, geotagged proof, reviews, and local credibility. Results still depend on market, site, and execution.',
