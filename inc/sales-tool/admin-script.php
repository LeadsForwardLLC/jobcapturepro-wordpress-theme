...
function jcp_sales_tool_call_script_chapters(): array {
	return [
		...
		[
			...
			'say'           => 'Here’s what operators and agencies say after they turn job photos into a system. [Read 1–2 snippets.] If Maps matters, walk Acculevel: Local Falcon drops pins across a service radius and checks Google’s 3-Pack at each point. SoLV is how often they win those top-three slots. Show before → after grids — more 3-Pack presence means more chances to get the call. Only quote a lead % if it’s verified in deck settings.',
			'say_affiliate' => 'Here’s proof you can forward. [Read 1–2 snippets.] Acculevel’s Local Falcon story: before nearly never in the 3-Pack across the grid; after up to ~100% SoLV. That’s Maps visibility that drives calls — explain SoLV in one sentence, then show the before/after card.',
			'say_partner'   => 'Here’s proof for a client pitch. [Read 1–2 snippets.] Acculevel Local Falcon before/after makes Maps value obvious without jargon: grid = service area, green = in the Google 3-Pack, SoLV = how often. Higher SoLV = more local discovery and calls.',
		...
		[
			...
			'say_affiliate' => 'Your motion is referral: 20% recurring commission for 12 months when someone you refer becomes a paid customer. Share your link, point them to start for free or try the demo, and let the product close.',
		...
		[
			...
			'say'           => 'Here’s what I’d recommend: start for free, connect one real job workflow, and we’ll confirm the rollout. I’ll download a one-pager with your numbers you can share with anyone who wasn’t on the call.',
			...
			'ask'           => 'Who else needs to see this before you start for free — and when can we reconnect?',
...
function jcp_sales_tool_call_script_objections(): array {
	return [
		...
		[
			...
			'say'   => 'You’re recommending something they already do — finish jobs and take photos. Point them to start for free; you earn when they become a paid customer.',
