...
function jcp_sales_tool_call_script_chapters(): array {
	return [
		...
		[
			...
			'say'           => 'Most home-service teams already have the content. It just dies on phones. One photo becomes proof in five places: Website, Google, Social, Directory, and a Review opportunity. Local search and AI answers want real work and real proof — and most shops never publish it consistently.',
		...
		[
			...
			'say'           => 'Here’s what operators and agencies say after they turn job photos into a system. [Read 1–2 snippets.] If Maps matters, walk the simple story: a multi-location foundation company went from invisible on Google Maps to showing up across town in ~90 days — Triadelphia and Monroe, foundation repair + waterproofing. Red = not showing up. Green = near the top. Only quote lead % if verified in deck settings. Not a ranking guarantee.',
			'say_affiliate' => 'Here’s proof you can forward. [Read 1–2 snippets.] Anonymous before/after on real Google Maps: 0% of the map → up to 100% covered in ~12 weeks across two markets. One line: more of the map showing them means more chances to get the call.',
			'say_partner'   => 'Here’s proof for a client pitch. [Read 1–2 snippets.] Simple before/after maps in two markets over ~12 weeks: invisible → showing up across town. Claim-safe — no ranking guarantees.',
		...
		[
			...
			'say'           => 'Based on location count, here’s the recommended plan from live pricing. One location → Starter ($99/mo, 1 location only). Multi-location → Scale ($249/mo + $150/mo per extra location, includes 1 Local Falcon keyword tracked). Large / custom integrations → Enterprise ($399/mo, extras $100/mo, includes 3 Local Falcon keywords tracked). Local Falcon = grid scans that measure Map Pack coverage and average rank for a search phrase. Point to the live pricing page for current numbers.',
		...
		[
			...
			'ask'           => 'Who else needs to see this before you Start Free Trial — and when can we reconnect?',
...
function jcp_sales_tool_call_script_objections(): array {
	return [
		...
		[
			...
			'proof' => 'If relevant, show anonymous Google Maps visibility — red means not showing up, green means near the top across town. Show measured movement, not promises.',
		],
		[
			'mode'  => 'affiliate',
			'title' => 'Will contractors actually buy?',
			'say'   => 'You’re recommending something they already do — finish jobs and take photos. Point them to Start Free Trial; you earn when they become a paid customer.',
