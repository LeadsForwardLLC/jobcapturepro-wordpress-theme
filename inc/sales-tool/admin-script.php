...
function jcp_sales_tool_call_script_chapters(): array {
	return [
		...
		[
			...
			'say_affiliate' => 'Here’s proof you can forward. [Read 1–2 snippets.] If Maps is the buying trigger for someone you refer, Acculevel’s LocalFalcon scans show measured visibility movement — not hype.',
			'say_partner'   => 'Here’s proof for a client pitch. [Read 1–2 snippets.] If Maps/SEO is the buying trigger, Acculevel LocalFalcon scans show measured visibility — use only when relevant.',
