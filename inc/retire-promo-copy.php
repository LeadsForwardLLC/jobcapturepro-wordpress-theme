...
function jcp_core_replace_retired_promo_copy( string $text ): string {
	if ( $text === '' || ( stripos( $text, 'early bird' ) === false && stripos( $text, 'founding crew' ) === false && stripos( $text, 'EARLYBIRD' ) === false ) ) {
		return $text;
	}
	...
	$replacements = [
		...
		'get early bird pricing and unlock the benefits of turning real work into reviews, visibility, and trust that drives inbound demand.' =>
			'Start a free 14-day trial and turn real work into reviews, visibility, and trust that drives inbound demand.',
		'Get early bird pricing' => 'Start a free 14-day trial',
		'get early bird pricing' => 'start a free 14-day trial',
		'early bird pricing'     => 'free 14-day trial pricing',
		'Early Bird pricing'     => 'Free 14-day trial pricing',
